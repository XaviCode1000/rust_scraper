...
This project is indexed by GitNexus as **rust_scraper** (3021 symbols, 6253 relationships, 264 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
