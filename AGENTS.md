...
This project is indexed by GitNexus as **rust_scraper** (2861 symbols, 5742 relationships, 251 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
