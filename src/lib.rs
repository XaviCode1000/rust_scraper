...
pub mod cli;
pub use cli::{
    config::{ConfigDefaults, init_logging_dual, is_no_color, should_emit_emoji},
...
pub struct Args {
    ...
    #[arg(short = 'f', long, default_value = "markdown", value_enum, env = "RUST_SCRAPER_FORMAT")]
    #[clap(next_help_heading = "Output")]
    ...
    #[arg(long, default_value = "jsonl", value_enum, env = "RUST_SCRAPER_EXPORT_FORMAT")]
    #[clap(next_help_heading = "Output")]
    ...
    #[cfg(not(feature = "ai"))]
    #[arg(long, default_value = "false", hide = true, env = "RUST_SCRAPER_CLEAN_AI")]
    pub clean_ai: bool,
    ...
    #[arg(short = 'n', long, default_value = "false", env = "RUST_SCRAPER_DRY_RUN")]
    #[clap(next_help_heading = "Display")]
    pub dry_run: bool,
}
...
pub fn version_string() -> String {
    ...
    format!("rust-scraper {} (commit: {}, build: {})", env!("CARGO_PKG_VERSION"), commit, build)
}
