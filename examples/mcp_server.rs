...
use rust_scraper::infrastructure::mcp_server::{McpState, server::build_mcp_router};
...
async fn main() {
    ...
    let container = Container::new(config).await.expect("failed to create container");
    ...
    println!(r#"  -d '{{"jsonrpc":"2.0","method":"initialize","params":{{"protocolVersion":"2024-11-05","capabilities":{{}},"clientInfo":{{"name":"test","version":"1.0.0"}}}},"id":1}}'"#);
